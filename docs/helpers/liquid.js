/*
 * liquidjs@8.2.2, https://github.com/harttle/liquidjs
 * (c) 2016-2019 harttle
                      ...
                      case 1:
                          ...
                          switch (file) {
                            case 'template.liquid':
                              filepath = paths_1.filter(path => path.includes('helpers'));
                              break;
                            case 'page.buy.liquid':
                              filepath = paths_1.filter(path => path.includes('templates'));
                              break;
                            default:
                              filepath = paths_1.filter(path => path.includes('snippets'));
                              break;
                          }
